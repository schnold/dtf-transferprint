...
ADD COLUMN "requiresInquiry" BOOLEAN NOT NULL DEFAULT false;
...
CREATE INDEX "products_requiresInquiry_idx" ON "products" ("requiresInquiry");
...
CREATE INDEX idx_form_requests_product_id ON form_requests(product_id);
